"""
Comprehensive error handling middleware for TTS API
...
class ErrorHandlerMiddleware(BaseHTTPMiddleware):
    """Global error handling middleware for TTS API"""
        ...
        try:
            ...
            return JSONResponse(
                ...
                content={
                    ...
                    "detail": "Unable to connect to Google Cloud TTS service",
                    "type": "connection_error",
                    "request_id": request_id,
                    "solutions": [
                        "Check Google Cloud credentials",
                        "Verify network connectivity",
                        "Check Google Cloud TTS API status"
                    ]
                }
            )
            ...
            return JSONResponse(
                ...
                content={
                    ...
                    "solutions": [
                        ...
                        "Ensure audio encoding is supported"
                    ]
                }
            )
            ...
            return JSONResponse(
                ...
                content={
                    ...
                    "detail": "An unexpected error occurred in the TTS service",
                    "type": "internal_error",
                    "request_id": request_id,
                    "solutions": [
